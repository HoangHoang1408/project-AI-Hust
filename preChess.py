...
def start_game():
    ...
    if mode == "Human vs Machine":
        ...
        machine_match(screen= screen, depth_machine_1= depth_machine_1, depth_machine_2= depth_machine_2)
    else:    
        human_match(screen)
...
def select_mode(screen):
    ...
    while True:
        ...
        screen.blit(machine_machine_text, (machine_machine.x + 10, machine_machine.y + 10))
...
def human_machine_match(screen, depth, side):
    if side == "white":
        ...
        game = ChessGame2(screen= screen, ai_2_level = depth, ai_side = False)
        game.start()

def machine_match(screen, depth_machine_1, depth_machine_2):
    game = ChessGame2(screen= screen, ai_1_level = depth_machine_1, ai_2_level = depth_machine_2)
    game.start()
